...
from core.runner import (
    ...
    thread_free_bot_limit, thread_per_bot_auto_restart,  # <-- added
    init_runner
)
...
@flask_app.route('/')
def flask_home():
    return "<h1>🌟 CHINKOR HOSTING PANEL 🌟</h1><p>Status: ✅ Online</p>"
...
def handle_callback(call):
    ...
    try:
        ...
        # ─── BOT OPERATIONS ───
            ...
            auto = bd.get('auto_restart_24h', 0)   # <-- read flag
            t = (
            ...
            safe_edit(t, chat_id, msg_id, reply_markup=bot_action_kb(bid, rn, auto))
            safe_answer(call.id)
        ...
        # ─── ADMIN CALLBACKS ───
            ...
            if not channels:
                t += "  No custom channels. Default: @chinkor\n"
            t += "\n━━━━━━━━━━━━━━━━━━━━"
            ...
            if not channels_r:
                t_ch += "  No custom channels. Default: @chinkor\n"
            t_ch += "\n━━━━━━━━━━━━━━━━━━━━"
        ...
        # ─── NEW: toggle per-bot auto-restart ───

"""
╔═══════════════════════════════════════════════════════════╗
║  🌟 CHINKOR HOSTING PANEL — Premium Edition v6.0 🌟         ║
║  Developer: @chinkor                               ║
...
ADMIN_ID       = OWNER_ID
BOT_USERNAME   = os.environ.get('BOT_USERNAME', 'ChinkorHostBot')
...
# ═══════════════════════════════════════════════════
#  MAIN BOT AUTO-RESTART (every 24h) — এখন আর ব্যবহার করা হয় না
# ═══════════════════════════════════════════════════
# সেটি সরিয়ে ফেলা হয়েছে। এখন প্রতি বটের জন্য আলাদা টগল আছে।
# MAIN_BOT_AUTO_RESTART_HOURS = int(os.environ.get('MAIN_BOT_AUTO_RESTART_HOURS', '24'))  # আর ব্যবহার হয় না